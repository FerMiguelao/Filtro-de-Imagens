        ...
        public Bitmap Moda(Bitmap Imagem)
        {
            ...
            for (i = 1; i < Largura - 1; i++)
            {
                for (j = 1; j < Altura - 1; j++)
                {
                    ...
                    vetor = Ordenacao.quickSort(todosPixeisR);
                    moda = CalcularModa(todosPixeisR, valor);
                    ...
                    vetor = Ordenacao.quickSort(todosPixeisG);
                    moda = CalcularModa(todosPixeisG, valor);
                    ...
                    vetor = Ordenacao.quickSort(todosPixeisB);
                    moda = CalcularModa(todosPixeisB, valor);
                    ...
                    vetor = Ordenacao.quickSort(todosPixeisA);
                    moda = CalcularModa(todosPixeisA, valor);
