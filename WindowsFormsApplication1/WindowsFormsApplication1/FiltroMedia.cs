        ...
        public Bitmap MediaPonderada(Bitmap Imagem)
        {
            ...
            for (i = 1; i < Largura - 1; i++)
            {
                for (j = 1; j < Altura - 1; j++)
                {
                    ...
                    mediaP = CalcularMediaPonderada(todosPixeisR, valor);
                    ...
                    mediaP = CalcularMediaPonderada(todosPixeisG, valor);
                    ...
                    mediaP = CalcularMediaPonderada(todosPixeisB, valor);
                    ...
                    mediaP = CalcularMediaPonderada(todosPixeisA, valor);
